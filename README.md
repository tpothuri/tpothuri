...
*A deep dive into predictive modeling and neural networks.*
* **Tech:** TensorFlow, PyTorch, Scikit-learn, EDA.
* **Key Achievement:** Implemented multiple models ranging from regression for price prediction to deep learning for image classification.
